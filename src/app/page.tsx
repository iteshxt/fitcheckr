...
export default function Home() {
  ...
  return (
    <>
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 shadow-xl border border-white/20 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid lg:grid-cols-7 gap-6">
                    {/* Left Column - Result Image or Loading (Takes 4/7 width) */}
                    <div className="lg:col-span-4 order-2 lg:order-1">
                      {processingStage === 'processing' ? (
                        <div className="flex flex-col items-center justify-center bg-white/60 backdrop-blur-sm rounded-2xl p-12 shadow-lg border border-white/40 min-h-[600px]">
                          {/* Minimal Loading Spinner */}
                          <div className="relative mb-8">
                            <div className="w-16 h-16 border-4 border-gray-200 rounded-full animate-spin border-t-purple-600"></div>
                          </div>
                        ...
                        <div className="flex flex-col items-center justify-center bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/40 min-h-[600px]">
                    ...
                    {/* Right Column - Source Images & Actions (Takes 3/7 width) */}
      ...
      {/* Footer */}
      <footer className="relative bg-white/40 backdrop-blur-xl border-t border-white/30 py-12 px-4 mt-8 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
